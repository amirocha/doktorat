...
x1_ran_df = spec_df[(spec_df[0] > -20.0) & (spec_df[0] < -10.)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] > -10.) & (spec_df[0] < -7.)]

#change ranges!!
# NGC1333 HCN10: -30.0 - -20.0  and -5. - -1.
# NGC1333 C34S32: -20.0 - -10.0  and -10. - -7.
...
"""
v_hcn10, Tmb_hcn10 = loadtxt('ngc1333_c34s32_ave_spec.txt', usecols=(0, 1), unpack=True, skiprows=1)
