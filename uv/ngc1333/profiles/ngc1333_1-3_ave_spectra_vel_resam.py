...
########## C34S 3-2 ##########
"""
v_c34s32_p1, Tmb_c34s32_p1 = loadtxt('./ngc1333_c34s32_I2A.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## CS 3-2 ##########
"""
v_cs32_p1, Tmb_cs32_p1 = loadtxt('./ngc1333_cs32_I2A.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## H13CN 1-0 ##########
"""
v_h13cn10_p1, Tmb_h13cn10_p1 = loadtxt('./ngc1333_h13cn10_I2A.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
##########  HCN 1-0 ##########
"""
v_hcn10_p1, Tmb_hcn10_p1 = loadtxt('./ngc1333_hcn10_I2A.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## CN 1-0 ##########
"""
v_cn10_p1, Tmb_cn10_p1 = loadtxt('./ngc1333_cn10_I2A.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax1.axvline(x=7.7, linewidth=0.7)
...
ax1.annotate(r'$\mathrm{IRAS\;2A}$', color='blue', fontsize=18, xy=(-30.0, 20), textcoords='data')
...
########## C34S 3-2 ##########
"""
v_c34s32_p2, Tmb_c34s32_p2 = loadtxt('./ngc1333_c34s32_I2B.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
##########  CS 3-2  ##########
"""
v_cs32_p2, Tmb_cs32_p2 = loadtxt('./ngc1333_cs32_I2B.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## H13CN 1-0 ##########
"""
v_h13cn10_p2, Tmb_h13cn10_p2 = loadtxt('./ngc1333_h13cn10_I2B.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## HCN 1-0 ##########
"""
v_hcn10_p2, Tmb_hcn10_p2 = loadtxt('./ngc1333_hcn10_I2B.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## CN 1-0 ##########
"""
v_cn10_p2, Tmb_cn10_p2 = loadtxt('./ngc1333_cn10_I2B.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax2.axvline(x=7.7, linewidth=0.7)

"""
########## C34S 3-2 (x 3) ##########
"""
ax2.plot(v_c34s32_p2, 3*(Tmb_c34s32_p2) + 16.0, color = 'black', linewidth=1.0, linestyle = '-')
ax2.axhline(y=16, xmin = -90.0, xmax = 40.0, color = 'green', linewidth=1, linestyle = '-')

"""
########## CS 3-2 ##########
"""
ax2.plot(v_cs32_p2, Tmb_cs32_p2 + 12.0, color = 'black', linewidth=1.0, linestyle = '-')
ax2.axhline(y=12, xmin = -90.0, xmax = 40.0, color = 'green', linewidth=1.0, linestyle = '-')

"""
########## H13CN 1-0 (x 5) ##########
"""
ax2.plot(v_h13cn10_p2, 5*(Tmb_h13cn10_p2) + 8.0, color = 'black', linewidth=1.0, linestyle = '-')
ax2.axhline(y=8, xmin = -90.0, xmax = 40.0, color = 'green', linewidth=1.0, linestyle = '-')
...
ax2.annotate(r'$\mathrm{C^{34}S\;\;3-2\;(\times3)}$', fontsize=12, xy=(-85.0, 18.0), textcoords='data')
ax2.annotate(r'$\mathrm{CS\;\;3-2}$', fontsize=12, xy=(-85.0, 14), textcoords='data')
ax2.annotate(r'$\mathrm{H^{13}CN\;\;1-0\;(\times5)}$', fontsize=12, xy=(-85.0, 10.0), textcoords='data')
ax2.annotate(r'$\mathrm{HCN\;\;1-0}$', fontsize=12, xy=(-85.0, 5.5), textcoords='data')
ax2.annotate(r'$\mathrm{CN\;\;1-0}$', fontsize=12, xy=(-85.0, 1.7), textcoords='data')
ax2.annotate(r'$\mathrm{IRAS\;2B}$', color='blue', fontsize=18, xy=(-30.0, 20), textcoords='data')
...
##########  C34S 3-2 ##########
"""
v_c34s32_p3, Tmb_c34s32_p3 = loadtxt('./ngc1333_c34s32_HRF65.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## CS 3-2 ##########
"""
#v_cs32_p3, Tmb_cs32_p3 = loadtxt('./ngc1333_cs32_HRF65.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## H13CN 1-0 ##########
"""
v_h13cn10_p3, Tmb_h13cn10_p3 = loadtxt('./ngc1333_h13cn10_HRF65.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## HCN 1-0 ##########
"""
v_hcn10_p3, Tmb_hcn10_p3 = loadtxt('./ngc1333_hcn10_HRF65.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## CN 1-0 ##########
"""
v_cn10_p3, Tmb_cn10_p3 = loadtxt('./ngc1333_cn10_HRF65.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax3.axvline(x=7.7, linewidth=0.7)

"""
########## C34S 3-2 (x 3) ##########
"""
ax3.plot(v_c34s32_p3, 3*(Tmb_c34s32_p3) + 16.0, color = 'black', linewidth=1.0, linestyle = '-')
ax3.axhline(y=16, xmin = -90.0, xmax = 40.0, color = 'green', linewidth=1, linestyle = '-')


"""
########## CS 3-2 ##########
"""
#ax3.plot(v_cs32_p3, Tmb_cs32_p3 + 12.0, color = 'black', linewidth=1.0, linestyle = '-')
#ax3.axhline(y=12, xmin = -90.0, xmax = 40.0, color = 'green', linewidth=1, linestyle = '-')

"""
########## H13CN 1-0 (x 5) ##########
"""
ax3.plot(v_h13cn10_p3, 5*(Tmb_h13cn10_p3) + 8.0, color = 'black', linewidth=1.0, linestyle = '-')
ax3.axhline(y=8, xmin = -90.0, xmax = 40.0, color = 'green', linewidth=1, linestyle = '-')

"""
########## HCN 1-0 ##########
"""
ax3.plot(v_hcn10_p3, (Tmb_hcn10_p3)/2 + 4.0, color = 'black', linewidth=1.0, linestyle = '-')
...
ax3.annotate(r'$\mathrm{C^{34}S\;\;3-2\;(\times3)}$', fontsize=12, xy=(-85.0, 18.0), textcoords='data')
#ax3.annotate(r'$\mathrm{CS\;\;3-2}$', fontsize=12, xy=(-85.0, 14.), textcoords='data')
ax3.annotate(r'$\mathrm{H^{13}CN\;\;1-0\;(\times5)}$', fontsize=12, xy=(-85.0, 10.0), textcoords='data')
ax3.annotate(r'$\mathrm{HCN\;\;1-0}$', fontsize=12, xy=(-85.0, 5.5), textcoords='data')
ax3.annotate(r'$\mathrm{CN\;\;1-0}$', fontsize=12, xy=(-85.0, 1.7), textcoords='data')
ax3.annotate(r'$\mathrm{HRF\;65}$', color='blue', fontsize=18, xy=(-30.0, 20), textcoords='data')
