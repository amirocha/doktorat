...
########## C34S 3-2 ##########
"""
v_c34s32_p1, Tmb_c34s32_p1 = loadtxt('./ngc1333_c34s32_I4A.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## CS 3-2 ##########
"""
v_cs32_p1, Tmb_cs32_p1 = loadtxt('./ngc1333_cs32_I4A.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## H13CN 1-0 ##########
"""
v_h13cn10_p1, Tmb_h13cn10_p1 = loadtxt('./ngc1333_h13cn10_I4A.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
##########  HCN 1-0 ##########
"""
v_hcn10_p1, Tmb_hcn10_p1 = loadtxt('./ngc1333_hcn10_I4A.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## CN 1-0 ##########
"""
v_cn10_p1, Tmb_cn10_p1 = loadtxt('./ngc1333_cn10_I4A.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax1.annotate(r'$\mathrm{IRAS\;4A}$', color='blue', fontsize=18, xy=(-30.0, 20), textcoords='data')
...
########## C34S 3-2 ##########
"""
v_c34s32_p2, Tmb_c34s32_p2 = loadtxt('./ngc1333_c34s32_I4B.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
##########  CS 3-2  ##########
"""
v_cs32_p2, Tmb_cs32_p2 = loadtxt('./ngc1333_cs32_I4B.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## H13CN 1-0 ##########
"""
v_h13cn10_p2, Tmb_h13cn10_p2 = loadtxt('./ngc1333_h13cn10_I4B.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## HCN 1-0 ##########
"""
v_hcn10_p2, Tmb_hcn10_p2 = loadtxt('./ngc1333_hcn10_I4B.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## CN 1-0 ##########
"""
v_cn10_p2, Tmb_cn10_p2 = loadtxt('./ngc1333_cn10_I4B.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax2.axvline(x=7.2, linewidth=0.7)
...
ax2.annotate(r'$\mathrm{IRAS\;4B}$', color='blue', fontsize=18, xy=(-30.0, 20), textcoords='data')
...
##########  C34S 3-2 ##########
"""
#v_c34s32_p3, Tmb_c34s32_p3 = loadtxt('./ngc1333_c34s32_I4C.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## CS 3-2 ##########
"""
v_cs32_p3, Tmb_cs32_p3 = loadtxt('./ngc1333_cs32_I4C.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## H13CN 1-0 ##########
"""
#v_h13cn10_p3, Tmb_h13cn10_p3 = loadtxt('./ngc1333_h13cn10_I4C.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## HCN 1-0 ##########
"""
v_hcn10_p3, Tmb_hcn10_p3 = loadtxt('./ngc1333_hcn10_I4C.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## CN 1-0 ##########
"""
v_cn10_p3, Tmb_cn10_p3 = loadtxt('./ngc1333_cn10_I4C.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax3.axvline(x=7.2, linewidth=0.7)
...
ax3.annotate(r'$\mathrm{IRAS\;4C}$', color='blue', fontsize=18, xy=(-30.0, 20), textcoords='data')
