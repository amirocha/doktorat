...
rms = 1.619E-02 # rms taken from CLASS
rms_3 = 3*rms
rms_15 = 15*rms
file_in = './ngc1333_cs32_ave_spec.txt'
...
x1_ran_df = spec_df[(spec_df[0] > -20.) & (spec_df[0] < -10)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] > -10) & (spec_df[0] < 0)]
...
"""
v_hcn10, Tmb_hcn10 = loadtxt(file_in, usecols=(0, 1), unpack=True, skiprows=1)
...
major_ticks_x = np.arange(-80, 80, 10)                                              
minor_ticks_x = np.arange(-85, 80, 10) 
...
plt.axvline(x=final4_df[1].ix[min4].round(1), color='blue', linestyle='--')
