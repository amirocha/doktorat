...
AV = ['1.500D+00', '0.500D+00', '-0.50D+00', '-1.50D+00', '1.000D+00', '0.000D+00', '-1.00D+00']
...
def make_picture(X, Y, Z):
	...
	ax.text(-1.5, 4.15, '$T$ = 50K', fontsize=14, verticalalignment='bottom', bbox=props)
	ax.text(-1.5, 5.75, r'$\frac{X(CN)}{X(HCN)}$', fontsize=18, color='k', bbox=props)

	plt.savefig('contour_plot_CN_HCN_50K.eps')
	plt.close()
