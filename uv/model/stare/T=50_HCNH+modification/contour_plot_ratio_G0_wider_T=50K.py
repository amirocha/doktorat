...
AV = ['2.500D+00', '1.500D+00', '0.500D+00', '1.000D+00', '0.000D+00', '-1.00D+00', '-0.50D+00', '-1.50D+00', '-2.50D+00']
...
def make_picture(X, Y, Z):
	...
	ax.text(-3, 4.15, '$T$ = 50K', fontsize=14, verticalalignment='bottom', bbox=props)
	ax.text(-3, 5.75, r'$\frac{X(CN)}{X(HCN)}$', fontsize=18, color='k', bbox=props)

	plt.savefig('G0_50K_modification.eps')
	plt.close()
