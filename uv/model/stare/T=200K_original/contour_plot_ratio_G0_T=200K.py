...
AV = ['2.500D+00', '1.500D+00', '0.500D+00', '-0.50D+00', '-1.50D+00', '-2.50D+00', '2.000D+00', '1.000D+00', '0.000D+00', '-1.00D+00', '-2.00D+00']
...
def make_picture(X, Y, Z):
	...
	ax.text(1.15, 4.15, '$T$ = 200K', fontsize=14, verticalalignment='bottom', bbox=props)
	ax.text(1.25, 5.75, r'$\frac{X(CN)}{X(HCN)}$', fontsize=18, color='k', bbox=props)

	plt.savefig('contour_plot_CN_HCN_200K_new.eps')
	plt.close()
