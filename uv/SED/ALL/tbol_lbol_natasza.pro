...
pro tbol_lbol
 ...
 ; device,decomposed=0
  ...
  dist=5627.9 ;300 ;429.; Ced178.0 ; L483 200.0; RNO91 125. ;L723 300.;HH46 450. ;IRAS15 130.  ; Ced 178.0
...
!P.TICKLEN=0.03
  ...
  xname=['10!U1!N','10!U2!N','10!U3!N','!17 10!U4!N']
...
;  cgplot,  w, s, psym=1,/overplot
 ...
 ; cgtext, 1d2, 1d-4, '!18L!17!Dsubm!N/!18L!17!Dbol!N='+lumlumi, charsize=2
  ...
  cgplot, wl, fl/1000.*1.0d-26*2.9979d14/wl, /xlog, /ylog, xtit='!17 !4k!3 !17(!4l!3m!17)', ytit='!17 !4k!3 !18F!D!4k!3!N!17 (W m!u-2!n)',$
     position=[0.2,0.2,0.9,0.9],/xst,/yst,xminor=10,yminor=10,thick=4,symsize=2.0,$
  	xr=[10,1000],yr=[1d-14,1d-11],psym=cgsymcat(3),xtickname=xname
...
;  cgplot,wpacs,fpacs2*1.0d-26*2.9979d14/wpacs,symsize=2.0,psym=cgsymcat(9),color='black',/overplot
  ...
  cgtext,12,4d-12,'!17 #13388',charthick=5,charsize=2.5

  cgtext, 3d2, 4d-12, '!18L!17!Dbol!N=22 L', charsize=2
  cgtext, 7.5d2, 4d-12, '!D!10!Z(2609)!X!N',  FONT=1, CharSize=2.0,charth=5
  cgtext, 3d2, 2d-12, '!18T!17!Dbol!N=42 K', charsize=2;, format='(I2)'

;  cgtext, 3d2, 4d-12, '!18L!17!Dbol!N='+lumi, charsize=2;, format='(f5.1)'
 ; cgtext, 3d2, 2d-12, '!18T!17!Dbol!N='+tbolo, charsize=2;, format='(I2)'
