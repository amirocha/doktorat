...
pro tbol60
 ...
 ; fname3=strcompress('values60_'+obj+'_nodit.txt',/remove_all)
  ...
  dist=235. ;NGC1333 ; L483 200.0; RNO91 125. ;L723 300.;HH46 450. ;IRAS15 130.  ; Ced 178.0
...
; fl = flux in mJy  ;;; in Jy? AK
 ...
 q=where(wl ge 60)
  ...
  s3=fl(q)
  num3=n_elements(w3)
  integral3=tsum(2.9979d14/w3[(num3-1)-findgen(num3)],s3[(num3-1)-findgen(num3)]*1.0d-26)

  lumsub3=integral3*4.0*!Pi*(dist*3.0857d16)^2/3.86d26


  print, 'Lsubmm2', lumsub2
  
  lumlum2=lumsub2/lum*100
  lumlum3=lumsub3/lum*100
...
;------calculate Lsubmm-----------------------------------
 ...
 ;>60
  ...
  lumlumb=lumsub/lum*100
  print, 'L>60/Lbol', lumlum
...
;-------------------------------------------------------
  openw, 2, fname3
  printf, 2, dist,lum, lumlum2, tbol, lumlum3, lumin, lumlum, tbolin, lumlumb,format='(i4, 2x,f8.3, 2x,f10.5,2x, f6.2,2x, f6.2, 2x,f8.3, 2x,f10.5,2x, f6.2,2x, f6.2)'
  close, 2
 ;------------------------------------------------------- 
