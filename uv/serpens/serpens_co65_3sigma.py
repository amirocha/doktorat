...
rms = 1.149E-02 # rms taken from CLASS
rms_3 = 3*rms

# read the spectrum
spec_df = pd.read_table('./smm1/spectra/smm1_co65_112.txt', delim_whitespace=True, header=None)

### 3 SIGMA ### 3 SIGMA ### 3 SIGMA ### 3 SIGMA ### 3 SIGMA ###
# left (x1) and right (x2) ranges in which we are looking for minima 
x1_ran_df = spec_df[(spec_df[0] > -65.0) & (spec_df[0] < -45.)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] > 0) & (spec_df[0] < 15.)]
#change ranges!!
# SERPENS HCN10: -5.0 - -0.0  and 10. - 20.
# Serpens co65: -5.0 - 5.0  and 10. - 20.
#SMM1 co65 1: 
...
"""
v_hcn10, Tmb_hcn10 = loadtxt('./smm1/spectra/smm1_co65_112.txt', usecols=(0, 1), unpack=True, skiprows=1)
