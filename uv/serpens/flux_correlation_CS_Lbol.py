...
def plot_correlation(x, y, a, b, pearson):
	...
	plt.savefig('CS_Lbol_correlation', format='eps')
	plt.close()
...
def main():
	...
	Lbol, CS_list = sort_points(Lbol, CS_list)

	a, b, stderr = fit_linear_regression(Lbol, CS_list)
	pearson = calculate_pearson(Lbol, CS_list)
	plot_correlation(Lbol, CS_list, a, b, pearson)
