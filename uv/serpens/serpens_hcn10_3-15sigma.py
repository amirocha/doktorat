...
psname = 'serpens_hcn10_3s_15s_main_component.eps'
...
x1_ran_df = spec_df[(spec_df[0] > 1.5) & (spec_df[0] < 5.)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] > 8.5) & (spec_df[0] < 10)]
...
x3_ran_df = spec_df[(spec_df[0] > 2.5) & (spec_df[0] < 7)]  #change ranges!!
x4_ran_df = spec_df[(spec_df[0] > 7) & (spec_df[0] < 8)]
