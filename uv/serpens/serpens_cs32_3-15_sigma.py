...
psname = 'serpens_cs32_3-15_sigma.eps #niedokończone
...
rms = 1.487E-02 # rms taken from CLASS
rms_3 = 3*rms

# read the spectrum
spec_df = pd.read_table('serpens_cs32_ave_spec.txt', delim_whitespace=True, header=None)
...
x2_ran_df = spec_df[(spec_df[0] > 10) & (spec_df[0] < 15.)]
...
"""
v_hcn10, Tmb_hcn10 = loadtxt('serpens_cs32_ave_spec.txt', usecols=(0, 1), unpack=True, skiprows=1)
