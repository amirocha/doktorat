...
for colour in ['red','blue']:
	file1=open('smm9_hcn10_'+colour+'_comp1.txt','r')
	...
	file2=open('smm9_hcn10_'+colour+'_comp2.txt','r')
	...
	file3=open('smm9_hcn10_'+colour+'_comp3.txt','r')
	...
	fileend=open('smm9_hcn10_'+colour+'.txt','w')
