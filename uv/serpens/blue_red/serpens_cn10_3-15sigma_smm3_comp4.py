...
psname = 'serpens_cn10_smm9_3s_15s_comp3.eps'
...
rms = 5.491E-02 # rms taken from CLASS
rms_3 = 3*rms
rms_15 = 45*rms
...
x1_ran_df = spec_df[(spec_df[0] > -42) & (spec_df[0] < -40.)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] > -38) & (spec_df[0] < -36)]
...
x3_ran_df = spec_df[(spec_df[0] > -40) & (spec_df[0] < -39)]  #change ranges!!
x4_ran_df = spec_df[(spec_df[0] > -39) & (spec_df[0] < -38)]
