...
psname = 'serpens_hcn10_smm9_3s_15s_comp1.eps'
...
# read the spectrum
spec_df = pd.read_table('./serpens_hcn10_smm9.txt', delim_whitespace=True, header=None)
...
"""
v_hcn10, Tmb_hcn10 = loadtxt('./serpens_hcn10_smm9.txt', usecols=(0, 1), unpack=True, skiprows=1)
