...
psname = 'serpens_hcn10_smm9_3s_15s_comp2.eps'
...
x1_ran_df = spec_df[(spec_df[0] > 3) & (spec_df[0] < 6)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] > 9.5) & (spec_df[0] < 11)]
...
x3_ran_df = spec_df[(spec_df[0] > 6) & (spec_df[0] < 8)]  #change ranges!!
