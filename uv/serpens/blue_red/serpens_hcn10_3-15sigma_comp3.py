...
psname = 'serpens_hcn10_smm1_3s_15s_comp3.eps'
...
x1_ran_df = spec_df[(spec_df[0] > -2.5) & (spec_df[0] < -0.8)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] > 2) & (spec_df[0] < 3)]
...
x3_ran_df = spec_df[(spec_df[0] > -0.8) & (spec_df[0] < 1)]  #change ranges!!
x4_ran_df = spec_df[(spec_df[0] > 1.) & (spec_df[0] < 2)]
