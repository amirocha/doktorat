...
for colour in ['red','blue']:
	file1=open('smm9_cn10_'+colour+'_comp1.txt','r')
	...
	file2=open('smm9_cn10_'+colour+'_comp2.txt','r')
	...
	file3=open('smm9_cn10_'+colour+'_comp3.txt','r')
	...
	file4=open('smm9_cn10_'+colour+'_comp4.txt','r')
	...
	file5=open('smm9_cn10_'+colour+'_comp5.txt','r')
	...
	fileend=open('smm9_cn10_'+colour+'.txt','w')
