...
x1_ran_df = spec_df[(spec_df[0] > -71) & (spec_df[0] < -69.5)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] >  -69) & (spec_df[0] < -67)]
...
x3_ran_df = spec_df[(spec_df[0] > -70) & (spec_df[0] < -69.5)]  #change ranges!!
x4_ran_df = spec_df[(spec_df[0] > -69.5) & (spec_df[0] < -68)]
