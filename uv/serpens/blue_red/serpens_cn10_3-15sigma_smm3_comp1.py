...
psname = 'serpens_cn10_smm3_3s_15s_main_component.eps'
...
rms = 6.246E-02 # rms taken from CLASS
rms_3 = 3*rms
rms_15 = 45*rms
...
x2_ran_df = spec_df[(spec_df[0] > 9) & (spec_df[0] < 11)]
...
x3_ran_df = spec_df[(spec_df[0] > 7) & (spec_df[0] < 8)]  #change ranges!!
x4_ran_df = spec_df[(spec_df[0] > 7.5) & (spec_df[0] < 10)]
