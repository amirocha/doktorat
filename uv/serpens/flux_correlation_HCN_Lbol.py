...
def plot_correlation(x, y, a, b, pearson):
	...
	ax.set_ylabel("I(HCN 1-0) [K km/s]")
	...
	plt.savefig('HCN_Lbol_correlation', format='eps')
	plt.close()
...
def main():
	...
	Lbol, HCN_list = sort_points(Lbol, HCN_list)

	a, b, stderr = fit_linear_regression(Lbol, HCN_list)
	pearson = calculate_pearson(Lbol, HCN_list)
	plot_correlation(Lbol, HCN_list, a, b, pearson)
