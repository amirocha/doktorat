...
rms = 6.747E-02 # rms taken from CLASS
rms_3 = 3*rms

# read the spectrum
spec_df = pd.read_table('serpens_13co65_ave_spec.txt', delim_whitespace=True, header=None)

### 3 SIGMA ### 3 SIGMA ### 3 SIGMA ### 3 SIGMA ### 3 SIGMA ###
# left (x1) and right (x2) ranges in which we are looking for minima 
x1_ran_df = spec_df[(spec_df[0] > -5.0) & (spec_df[0] < 7.)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] > 10) & (spec_df[0] < 12.)]
...
x3_ran_df = spec_df[(spec_df[0] > -3.0) & (spec_df[0] < 7.0)]  #change ranges!!
x4_ran_df = spec_df[(spec_df[0] > 10.0) & (spec_df[0] < 17.1)]
...
"""
v_hcn10, Tmb_hcn10 = loadtxt('serpens_13co65_ave_spec.txt', usecols=(0, 1), unpack=True, skiprows=1)
