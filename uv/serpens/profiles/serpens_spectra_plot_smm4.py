...
psname = 'serpens_spectra_smm4.eps'
...
major_ticks_y = np.arange(0.0, 38, 4.0)                                              
minor_ticks_y = np.arange(0.0, 38, 0.5) 
...
ax1.annotate(r'$\mathrm{Protostar}$', color='blue', fontsize=18, xy=(-35.0, 35.5), textcoords='data')
...
ax2.annotate(r'$\mathrm{Outflow}$', color='blue', fontsize=18, xy=(-40.0, 35.5), textcoords='data')
