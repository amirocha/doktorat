...
ax1.axvline(x=7.3, linewidth=0.7, c='green')
ax1.axvline(x=10.1, linewidth=0.7, c='green')
...
ax1.axhline(y=19, xmin = 0.0, xmax = 20.0, color = 'green', linewidth=1.0, linestyle = '-')

"""
########## SERPENS, CS 3-2, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
ax1.plot(v_cs32_p1, Tmb_cs32_p1 + 14.0, color = 'black', linewidth=1.0, linestyle = '-')
ax1.axhline(y=14, xmin = 0.0, xmax = 20.0, color = 'green', linewidth=1.0, linestyle = '-')
...
ax1.axhline(y=10, xmin = 0.0, xmax = 20.0, color = 'green', linewidth=1, linestyle = '-')

"""
########## SERPENS, HCN 1-0, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
ax1.plot(v_hcn10_p1, Tmb_hcn10_p1 + 4.0, color = 'black', linewidth=1.0, linestyle = '-')
ax1.axhline(y=4, xmin = 0.0, xmax = 20.0, color = 'green', linewidth=1, linestyle = '-')

"""
########## SERPENS, CN 1-0, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
ax1.plot(v_cn10_p1, 2*Tmb_cn10_p1, color = 'black', linewidth=1.0, linestyle = '-')
ax1.axhline(y=0, xmin = 0.0, xmax = 20.0, color = 'green', linewidth=1, linestyle = '-')
...
ax1.axhline(y=22, xmin = 0.0, xmax = 20.0, color = 'green', linewidth=1, linestyle = '-')
...
ax1.axhline(y=29, xmin = 0.0, xmax = 20.0, color = 'green', linewidth=1, linestyle = '-')

ax1.annotate(r'$\mathrm{C^{18}O\;\;6-5\;(\times5)}$', fontsize=14, xy=(.0, 31), textcoords='data')
ax1.annotate(r'$\mathrm{CO\;\;6-5\;(\div2)}$', fontsize=14, xy=(.0, 25), textcoords='data')
ax1.annotate(r'$\mathrm{C^{34}S\;\;3-2\;(\times3)}$', fontsize=14, xy=(.0, 20.0), textcoords='data')
ax1.annotate(r'$\mathrm{CS\;\;3-2}$', fontsize=14, xy=(.0, 14.4), textcoords='data')
#ax1.annotate(r'$\mathrm{H^{13}CN\;\;2-1}$', fontsize=12, xy=(-85.0, 12.5), textcoords='data'
#)
ax1.annotate(r'$\mathrm{H^{13}CN\;\;1-0\;(\times5)}$', fontsize=14, xy=(-.0, 12.0), textcoords='data')
ax1.annotate(r'$\mathrm{HCN\;\;1-0}$', fontsize=14, xy=(.0, 4.5), textcoords='data')
ax1.annotate(r'$\mathrm{CN\;\;1-0\;(\times2)}$', fontsize=14, xy=(.0, 1.7), textcoords='data')
ax1.annotate(r'$\mathrm{SMM1}$', color='blue', fontsize=18, xy=(5.0, 34.5), textcoords='data')
