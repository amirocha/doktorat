...
ax1.annotate(r'$\mathrm{H^{13}CN\;\;1-0\;(\times5)}$', fontsize=12, xy=(-85.0, 12), textcoords='data')
...
ax1.annotate(r'$\mathrm{SMM5}$', color='blue', fontsize=18, xy=(-30.0, 28.5), textcoords='data')
...
#ax3.annotate(r'$\mathrm{H^{13}CN\;\;2-1\;(\times3)}$', fontsize=12, xy=(-85.0, 16), textcoords='data')
ax2.annotate(r'$\mathrm{H^{13}CN\;\;1-0\;(\times5)}$', fontsize=12, xy=(-85.0, 12), textcoords='data')
...
ax2.annotate(r'$\mathrm{SMM6}$', color='blue', fontsize=18, xy=(-30.0, 28.5), textcoords='data')
...
"""
v_c34s32_p3, Tmb_c34s32_p3 = loadtxt('./serpens_c34s32_smm8.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CS 3-2, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_cs32_p3, Tmb_cs32_p3 = loadtxt('./serpens_cs32_smm8.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, H13CN 2-1, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_h13cn21_p3, Tmb_h13cn21_p3 = loadtxt('./serpens_h13cn21_smm8.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, H13CN 1-0, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_h13cn10_p3, Tmb_h13cn10_p3 = loadtxt('./serpens_h13cn10_smm8.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, HCN 1-0, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_hcn10_p3, Tmb_hcn10_p3 = loadtxt('./serpens_hcn10_smm8.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CN 1-0, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_cn10_p3, Tmb_cn10_p3 = loadtxt('./serpens_cn10_smm8.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CO 6-5, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_co65_p3, Tmb_co65_p3 = loadtxt('./serpens_co65_smm8.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
#ax3.annotate(r'$\mathrm{H^{13}CN\;\;2-1\;(\times3)}$', fontsize=12, xy=(-85.0, 16), textcoords='data')
ax3.annotate(r'$\mathrm{H^{13}CN\;\;1-0\;(\times5)}$', fontsize=12, xy=(-85.0, 12), textcoords='data')
...
ax3.annotate(r'$\mathrm{SMM8}$', color='blue', fontsize=18, xy=(-30.0, 28.5), textcoords='data')
