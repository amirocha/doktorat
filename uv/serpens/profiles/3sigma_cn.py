...
rms = 6.067E-02 # rms taken from CLASS
rms_3 = 3*rms
rms_2 = 2*rms

name = 'serpens_cn10_smm9.txt'
# read the spectrum
...
x1_ran_df = spec_df[(spec_df[0] > 13) & (spec_df[0] < 14.5)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] > 15) & (spec_df[0] < 20)]
