...
rms = 4.951E-02 # rms taken from CLASS  CS ave: 1.513E-02, CO ave: 2.674E-02
rms_3 = 3*rms
rms_2 = 2*rms

#file name
name = 'serpens_h13cn10_smm8.txt'
...
x1_ran_df = spec_df[(spec_df[0] > 12) & (spec_df[0] < 12.5)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] > 13) & (spec_df[0] < 15)]
...
x3_ran_df = spec_df[(spec_df[0] > 12.0) & (spec_df[0] < 14.0)]  #change ranges!!
x4_ran_df = spec_df[(spec_df[0] > 14.0) & (spec_df[0] < 17.1)]
