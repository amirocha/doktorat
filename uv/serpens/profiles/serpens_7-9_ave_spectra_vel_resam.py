...
"""
v_c34s32_p1, Tmb_c34s32_p1 = loadtxt('./serpens_c34s32_smm10.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CS 3-2, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_cs32_p1, Tmb_cs32_p1 = loadtxt('./serpens_cs32_smm10.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
"""
v_h13cn10_p1, Tmb_h13cn10_p1 = loadtxt('./serpens_h13cn10_smm10.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, HCN 1-0, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_hcn10_p1, Tmb_hcn10_p1 = loadtxt('./serpens_hcn10_smm10.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CN 1-0, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_cn10_p1, Tmb_cn10_p1 = loadtxt('./serpens_cn10_smm10.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CO 6-5, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_co65_p1, Tmb_co65_p1 = loadtxt('./serpens_co65_smm10.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax1.annotate(r'$\mathrm{SMM10}$', color='blue', fontsize=18, xy=(-30.0, 25.5), textcoords='data')
...
"""
v_c34s32_p2, Tmb_c34s32_p2 = loadtxt('./serpens_c34s32_smm12.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CS 3-2, center: 142.5 -126.2, range: 128.6 156.4 -140.1 -112.3 ##########
"""
v_cs32_p2, Tmb_cs32_p2 = loadtxt('./serpens_cs32_smm12.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
"""
v_h13cn10_p2, Tmb_h13cn10_p2 = loadtxt('./serpens_h13cn10_smm12.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, HCN 1-0, center: 142.5 -126.2, range: 128.6 156.4 -140.1 -112.3 ##########
"""
v_hcn10_p2, Tmb_hcn10_p2 = loadtxt('./serpens_hcn10_smm12.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CN 1-0, center: 142.5 -126.2, range: 128.6 156.4 -140.1 -112.3 ##########
"""
v_cn10_p2, Tmb_cn10_p2 = loadtxt('./serpens_cn10_smm12.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CO 6-5, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_co65_p2, Tmb_co65_p2 = loadtxt('./serpens_co65_smm12.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax2.annotate(r'$\mathrm{SMM12}$', color='blue', fontsize=18, xy=(-30.0, 25.5), textcoords='data')
...
"""
v_c34s32_p3, Tmb_c34s32_p3 = loadtxt('./serpens_c34s32_pos1.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CS 3-2, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_cs32_p3, Tmb_cs32_p3 = loadtxt('./serpens_cs32_pos1.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
"""
v_h13cn10_p3, Tmb_h13cn10_p3 = loadtxt('./serpens_h13cn10_pos1.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, HCN 1-0, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_hcn10_p3, Tmb_hcn10_p3 = loadtxt('./serpens_hcn10_pos1.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CN 1-0, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_cn10_p3, Tmb_cn10_p3 = loadtxt('./serpens_cn10_pos1.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CO 6-5, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_co65_p3, Tmb_co65_p3 = loadtxt('./serpens_co65_pos1.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax3.annotate(r'$\mathrm{Outflow1}$', color='blue', fontsize=18, xy=(-30.0, 25.5), textcoords='data')
