...
rms = 2.674E-02  # rms taken from CLASS  CS ave: 1.513E-02, CO ave: 2.674E-02, C34S ave: 1.219E-02
rms_3 = 3*rms
rms_2 = 2*rms

name = 'serpens_co65_smm8.txt'
...
x1_ran_df = spec_df[(spec_df[0] > 6) & (spec_df[0] < 7)]    #change ranges!! 
...
x4_ran_df = spec_df[(spec_df[0] > 8.0) & (spec_df[0] < 18.1)]
