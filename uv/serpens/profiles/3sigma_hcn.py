...
rms = 4.951E-02 # rms taken from CLASS
rms_3 = 3*rms
rms_2 = 2*rms

name = 'serpens_hcn10_smm8.txt'
# read the spectrum
...
x1_ran_df = spec_df[(spec_df[0] > -8) & (spec_df[0] < 1)]    #change ranges!! 
x2_ran_df = spec_df[(spec_df[0] > 18.5) & (spec_df[0] < 19)]
