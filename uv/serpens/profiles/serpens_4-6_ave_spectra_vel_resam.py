...
"""
v_c34s32_p1, Tmb_c34s32_p1 = loadtxt('./serpens_c34s32_smm5.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CS 3-2, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_cs32_p1, Tmb_cs32_p1 = loadtxt('./serpens_cs32_smm5.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, H13CN 2-1, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
#v_h13cn21_p1, Tmb_h13cn21_p1 = loadtxt('./serpens_h13cn21_smm5.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, H13CN 1-0, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_h13cn10_p1, Tmb_h13cn10_p1 = loadtxt('./serpens_h13cn10_smm5.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, HCN 1-0, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_hcn10_p1, Tmb_hcn10_p1 = loadtxt('./serpens_hcn10_smm5.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CN 1-0, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_cn10_p1, Tmb_cn10_p1 = loadtxt('./serpens_cn10_smm5.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CO 6-5, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_co65_p1, Tmb_co65_p1 = loadtxt('./serpens_co65_smm5.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
major_ticks_y = np.arange(0.0, 30, 4.0)                                              
minor_ticks_y = np.arange(0.0, 30, 0.5) 
...
########## SERPENS, CS 3-2, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
ax1.plot(v_cs32_p1, Tmb_cs32_p1 + 18.0, color = 'black', linewidth=1.0, linestyle = '-')
ax1.axhline(y=18, xmin = -90.0, xmax = 40.0, color = 'green', linewidth=1.0, linestyle = '-')
...
"""
ax1.plot(v_co65_p1, Tmb_co65_p1 + 25, color = 'black', linewidth=1.0, linestyle = '-')
ax1.axhline(y=25, xmin = -90.0, xmax = 40.0, color = 'green', linewidth=1, linestyle = '-')


ax1.annotate(r'$\mathrm{CO\;\;6-5}$', fontsize=14, xy=(-85.0, 26), textcoords='data')
ax1.annotate(r'$\mathrm{C^{34}S\;\;3-2\;(\times3)}$', fontsize=12, xy=(-85.0, 23.0), textcoords='data')
ax1.annotate(r'$\mathrm{CS\;\;3-2}$', fontsize=12, xy=(-85.0, 20), textcoords='data')
ax1.annotate(r'$\mathrm{H^{13}CN\;\;2-1\;(\times3)}$', fontsize=12, xy=(-85.0, 16), textcoords='data')
ax1.annotate(r'$\mathrm{H^{13}CN\;\;1-0\;(\times5)}$', fontsize=12, xy=(-85.0, 11.5), textcoords='data')
...
ax1.annotate(r'$\mathrm{SMM5}$', color='blue', fontsize=18, xy=(-30.0, 30.5), textcoords='data')
...
"""
v_c34s32_p2, Tmb_c34s32_p2 = loadtxt('./serpens_c34s32_smm6.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CS 3-2, center: 142.5 -126.2, range: 128.6 156.4 -140.1 -112.3 ##########
"""
v_cs32_p2, Tmb_cs32_p2 = loadtxt('./serpens_cs32_smm6.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
"""
v_h13cn10_p2, Tmb_h13cn10_p2 = loadtxt('./serpens_h13cn10_smm6.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, HCN 1-0, center: 142.5 -126.2, range: 128.6 156.4 -140.1 -112.3 ##########
"""
v_hcn10_p2, Tmb_hcn10_p2 = loadtxt('./serpens_hcn10_smm6.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CN 1-0, center: 142.5 -126.2, range: 128.6 156.4 -140.1 -112.3 ##########
"""
v_cn10_p2, Tmb_cn10_p2 = loadtxt('./serpens_cn10_smm6.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CO 6-5, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_co65_p2, Tmb_co65_p2 = loadtxt('./serpens_co65_smm6.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
########## SERPENS, CS 3-2, center: 142.5 -126.2, range: 128.6 156.4 -140.1 -112.3 ##########
"""
ax2.plot(v_cs32_p2, Tmb_cs32_p2 + 18.0, color = 'black', linewidth=1.0, linestyle = '-')
ax2.axhline(y=18, xmin = -90.0, xmax = 40.0, color = 'green', linewidth=1.0, linestyle = '-')
...
ax2.annotate(r'$\mathrm{SMM6}$', color='blue', fontsize=18, xy=(-30.0, 30.5), textcoords='data')
...
"""
v_c34s32_p3, Tmb_c34s32_p3 = loadtxt('./serpens_c34s32_smm9.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CS 3-2, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_cs32_p3, Tmb_cs32_p3 = loadtxt('./serpens_cs32_smm9.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, H13CN 2-1, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_h13cn21_p3, Tmb_h13cn21_p3 = loadtxt('./serpens_h13cn21_smm9.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, H13CN 1-0, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_h13cn10_p3, Tmb_h13cn10_p3 = loadtxt('./serpens_h13cn10_smm9.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, HCN 1-0, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_hcn10_p3, Tmb_hcn10_p3 = loadtxt('./serpens_hcn10_smm9.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CN 1-0, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
v_cn10_p3, Tmb_cn10_p3 = loadtxt('./serpens_cn10_smm9.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CO 6-5, center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
v_co65_p3, Tmb_co65_p3 = loadtxt('./serpens_co65_smm9.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax3.axvline(x=8.5, linewidth=0.7)

"""
########## SERPENS, C34S 3-2 (x 3), center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
ax3.plot(v_c34s32_p3, 3*(Tmb_c34s32_p3) + 22.0, color = 'black', linewidth=1.0, linestyle = '-')
...
########## SERPENS, CS 3-2, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
ax3.plot(v_cs32_p3, Tmb_cs32_p3 + 18.0, color = 'black', linewidth=1.0, linestyle = '-')
ax3.axhline(y=18, xmin = -90.0, xmax = 40.0, color = 'green', linewidth=1, linestyle = '-')

"""
########## SERPENS, H13CN 2-1, center: 121.723 -113.342, range: 107.823 135.623 -127.242 -99.442 ##########
"""
ax3.plot(v_h13cn21_p3, 3*(Tmb_h13cn21_p3) + 14.0, color = 'black', linewidth=1.0, linestyle = '-')
...
########## SERPENS, CO ,- center: 163.5 -142.7, range: 149.6 177.4 -156.6 -128.8 ##########
"""
ax3.plot(v_co65_p3, Tmb_co65_p3 + 25, color = 'black', linewidth=1.0, linestyle = '-')
ax3.axhline(y=25, xmin = -90.0, xmax = 40.0, color = 'green', linewidth=1, linestyle = '-')


ax3.annotate(r'$\mathrm{CO\;\;6-5}$', fontsize=14, xy=(-85.0, 26), textcoords='data')
ax3.annotate(r'$\mathrm{C^{34}S\;\;3-2\;(\times3)}$', fontsize=12, xy=(-85.0, 23.0), textcoords='data')
ax3.annotate(r'$\mathrm{CS\;\;3-2}$', fontsize=12, xy=(-85.0, 20), textcoords='data')
ax3.annotate(r'$\mathrm{H^{13}CN\;\;2-1\;(\times3)}$', fontsize=12, xy=(-85.0, 16), textcoords='data')
ax3.annotate(r'$\mathrm{H^{13}CN\;\;1-0\;(\times5)}$', fontsize=12, xy=(-85.0, 11.5), textcoords='data')
...
ax3.annotate(r'$\mathrm{SMM9}$', color='blue', fontsize=18, xy=(-30.0, 30.5), textcoords='data')
