...
"""
v_cs32_p8, Tmb_cs32_p8 = loadtxt('./serpens_smm10_cs32.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
"""
v_h13cn10_p8, Tmb_h13cn10_p8 = loadtxt('./serpens_smm10_h13cn10.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, HCN 1-0, center: 136.373 -69.392, range: 122.473 150.273 -83.292 -55.492 ##########
"""
v_hcn10_p8, Tmb_hcn10_p8 = loadtxt('./serpens_smm10_hcn10.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CN 1-0, center: 136.373 -69.392, range: 122.473 150.273 -83.292 -55.492 ##########
"""
v_cn10_p8, Tmb_cn10_p8 = loadtxt('./serpens_smm10_cn10.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax1.annotate(r'$\mathrm{SMM10}$', color='red', fontsize=18, xy=(-50.0, 21.5), textcoords='data')
...
"""
v_cs32_p9, Tmb_cs32_p9 = loadtxt('./serpens_smm12_cs32.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
"""
v_h13cn10_p9, Tmb_h13cn10_p9 = loadtxt('./serpens_smm12_h13cn10.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, HCN 1-0, center: 123 -75.2, range: 109.1 136.9 -89.1 -61.3 ##########
"""
v_hcn10_p9, Tmb_hcn10_p9 = loadtxt('./serpens_smm12_hcn10.txt', usecols=(0, 1), unpack=True, skiprows=1)


"""
########## SERPENS, CN 1-0, center: 123 -75.2, range: 109.1 136.9 -89.1 -61.3 ##########
"""
v_cn10_p9, Tmb_cn10_p9 = loadtxt('./serpens_smm12_cn10.txt', usecols=(0, 1), unpack=True, skiprows=1)
...
ax2.annotate(r'$\mathrm{SMM12}$', color='red', fontsize=18, xy=(-50.0, 21.5), textcoords='data'
)
...
ax3.annotate(r'$\mathrm{Pos1}$', color='red', fontsize=18, xy=(-50.0, 21.5), textcoords='data'
)
...
ax4.annotate(r'$\mathrm{Pos2}$', color='red', fontsize=18, xy=(-50.0, 21.5), textcoords='data'
)
...
ax5.annotate(r'$\mathrm{Pos3}$', color='red', fontsize=18, xy=(-50.0, 21.5), textcoords='data')
...
ax6.annotate(r'$\mathrm{Pos4}$', color='red', fontsize=18, xy=(-50.0, 21.5), textcoords='data'
)
...
ax7.annotate(r'$\mathrm{Pos5}$', color='red', fontsize=18, xy=(-50.0, 21.5), textcoords='data')
