...
def integrate(x,y,mol,integrals):
	...
	for i in range(len(x)-1):
		if x[i]>-50.9 and x[i]<4.8:  #  Yildiz+2015: SMM1 blue: -10.5 6 //red: 10.5 31     old[CO6-5 SMM1: -50.9 4.8 (north), -50.1 12.9 (south)  HCN1-0: -4.8 1.1 (north)]
