...
starting_position=(-2.85, 1.65, -0.85, 3.65)
...
def main():
	for i in range(20): #change number of changes (depending on the outflow pixels size)
		if i not in [3,7,16]:
			generate_script(i) 

def calculate_positions(i):
	new_x1 = starting_position[0]-(i%4)*4.5  #watch out the signs!
	new_x2 = starting_position[1]-(i%4)*4.5
	new_y1 = starting_position[2]+(i//4)*4.5
	new_y2 = starting_position[3]+(i//4)*4.5
