...
%=================================================
%\begin{figure} 
%\centering \includegraphics[width=10cm]{G0_50K.eps} 
%\caption{Similar to
...
\label{reactions}      % is used to refer this table in the text \centering          
...
\label{model1} 
\centering
\includegraphics[width=1.\linewidth]{CN_Lbol_correlation.eps} 
%\caption{} 
\end{subfigure}
\begin{subfigure}{.45\textwidth} 
\label{model2} 
\centering
\includegraphics[width=1.\linewidth]{CN_Tbol_correlation.eps} 
%\caption{} 
\end{subfigure}
\begin{subfigure}{.45\textwidth} 
\label{model3} 
\centering
\includegraphics[width=1.\linewidth]{HCN_Lbol_correlation.eps} 
%\caption{}
\end{subfigure}
\begin{subfigure}{.45\textwidth} 
\label{model4} 
\centering
\includegraphics[width=1.\linewidth]{HCN_Tbol_correlation.eps} 
%\caption{} 
\end{subfigure}
\begin{subfigure}{.45\textwidth} \label{model5} 
\centering
\includegraphics[width=1.\linewidth]{CS_Lbol_correlation.eps} 
%\caption{} 
\end{subfigure}
\begin{subfigure}{.45\textwidth} 
\label{model6} 
\centering
\includegraphics[width=1.\linewidth]{CS_Tbol_correlation.eps} 
%\caption{} 
\end{subfigure}
